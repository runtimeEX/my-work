package com.rabbit.mq.listener.delay;
...
public class DelayListener {
    ...
    @RabbitListener(queues = DelayRabbitConfig.ORDER_DELAY_QUEUE, containerFactory = "multiListenerContainer")
    public void consumeMsgQueue(Message message, Channel channel) throws IOException {
        ...
        try {
            ...
            orderRecordService.updateOrder(jsonObject.getString("token"),"取消订单");
