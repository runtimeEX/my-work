...
public class Methods {
     ...
     * token
     */
    public static String token="e56392d1f68b41f89faa7546e27a77b4";

    /**
     * 刷新token需要的 refreshtoken
     */
    public static String refresh_token="95ddbf5fa4184f099d198338bb6e9d3d";
    ...
    public String getFreedomToken() {
        ...
        try {
            ...
            System.out.println("getFreedomToken出现Json异常！" + result);
            e.printStackTrace();
        }
        return result;
    }
