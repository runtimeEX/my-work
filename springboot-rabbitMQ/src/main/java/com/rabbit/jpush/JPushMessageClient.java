 ...
 * @version V1.0
 * @Project: ghs
 * @Package cn.vpclub.ghs.bff.wxmini.message.jpush.service
 * @Description: TODO
 * @date Date : 2021年11月11日 下午3:38
 */
@Component
@Slf4j
public class JPushMessageClient {
    @Value("${app.jpush-message.app-key}")
    private String appKey;

    @Value("${app.jpush-message.master-secret}")
    private String masterSecret;

    @Value("${app.jpush-message.apns-production}")
