 ...
 * @Package com.kafka
 * @Description: TODO
 * @date Date : 2021年05月11日 下午5:30
 *
 * 向量必须是一个与密钥长度相等的数据
 */
public class AESCBCUtil {
    private static final String KEY = "1234567890hijkel";
    ...
    public static String encrypt(String content, String key) {
        ...
        try {
          ...
          //  SecretKeySpec skeySpec = new SecretKeySpec(key.getBytes(CODE_TYPE), AES);
            ...
            return byte2Base64(result);//通过Base64转码返回
        } catch (Exception ex) {
        }
    ...
    public static void main(String[] args) {
        ...
        String s1 = AESCBCUtil.encrypt(content, key);
        System.out.println("result1:" + s1);
        System.out.println("result2:" + AESCBCUtil.decrypt(s1, key));
