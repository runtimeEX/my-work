package com.boss.wx.pay.channel.wxpay.kits;
        ...
        try {
            ...
            switch (wxPayConfig.getTradeType()) {
                case WxPayConstants.TradeType.JSAPI: {
                    ...
                    payInfo.put("paySign", SignUtils.sign(beforeSign, wxPayConfig.getPrivateKey()));
                    // 签名以后在增加prepayId参数
                ...
                case WxPayConstants.TradeType.APP: {
                    ...
                    payInfo.put("sign", SignUtils.sign(beforeSign, wxPayConfig.getPrivateKey()));
                    payInfo.put("prepayId", prepayId);
