...
public class QRCodeUtils {
    ...
    public static void main(String[] args) throws Exception {
        String text = "又菜又爱玩！！！";  //这里设置自定义网站url
        String logoPath = "/Users/zhouhao/Pictures/img/女孩唯美插画4k高清动漫壁纸_彼岸图网.jpg";
        String destPath = "/Users/zhouhao/Downloads";
        System.out.println(QRCodeUtils.encode(text, logoPath, destPath, true));

     //   System.out.println(decode("/Users/zhouhao/Downloads/47619013.jpg"));
    }
}
